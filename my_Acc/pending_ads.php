...
WHERE
form_prev_data.flag !='1' AND form_prev_data.flag !='4' AND
...
");
							...
							?>  
    							...
    							<td><?php  $flag=$row['flag']; 
							
							if($flag==0){
							    echo "Add On the Admin Pool";
							}
							if($flag==2){
							    echo "Add On the E-Broker Pool";
							}
							if($flag==3){
							    echo "Add On the E-Broker Reserve Pool";
							}
