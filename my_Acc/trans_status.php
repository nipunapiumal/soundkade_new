...
WHERE cus_transaction.cus_id='$uid'
...
form_prev_data.id='$post_id' AND form_prev_data.ebro_id='0'
"));
							...
							?>  
    							...
    							<td><?php  $flag=$row1['trans_flag']; 
							
							if($flag==0){
							    echo "Transaction on the RBO pool";
							}
							if($flag==2){
							    echo "Transaction On the E-Broker Pool";
							}
							if($flag==1){
							    echo "Transaction On the Consultant Pool";
							}
							if($flag==3){
							    echo "Transaction Accepted by E-Broker";
							}
