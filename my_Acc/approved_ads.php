...
<html lang="en-US" class="no-js">
	...
	<link rel="stylesheet" href="../backend/bootstrap-sweetalert/lib/sweet-alert.css" />
...
");
	...
	<script src="../backend/bootstrap-sweetalert/lib/sweet-alert.min.js"></script>
	...
	$('.remove_btn').click(function () {   //when press Delete button in the table		    
			...
			$.post("connection/remove_ad_data.php", {remove_ad: 'data', ad_id: ad_id}, function (delMsg) {//delete item
				...
				if (valueDel.msgType === 1) {
					...
					function (isConfirm) {
					    if (isConfirm) {
						window.location.href = "approved_ads.php";
					    }
					});
				    }, 300);
