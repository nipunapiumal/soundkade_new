...
if (array_key_exists('accept_ad', $_POST)) {//delete button of data table
    ...
    //UDARA'S CODE FOR UPDATE AD EXPIRE TIME, I set it to 60 days
    $expire_in = 60;//ad expire time in days, you can change it if you want
    ...
    if ($data) {
        ...
        $ad_url = "http://new.soundkade.lk/more_details.php?id=$add_id_1&e_bro=0&user={$row['cus_id']}";
