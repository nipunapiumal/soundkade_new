...
$sql5 = "SELECT * FROM province WHERE pid='$id'";
$result5 = mysqli_query($conn, $sql5);
while ($row5 = mysqli_fetch_array($result5)) {

    $province = $row5['province'];
}
?>
                                    ...
                                    <div class="widget-body"> 
                                        <div class="widget-main"> 
                                            ...
                                            <form class="form-horizontal" role="form" 
                                                  action="function/edit_province_fun.php?id=<?php echo $id; ?>&&province2=<?php echo $province; ?>" method="post">
                                                <div class="form-group"> 
                                                    <label>Edit Province</label>
                                                    <div class="input-group"> <span class="input-group-addon"> 
                                                            <i class="glyphicon glyphicon-map-marker"></i> </span> 
                                                        <input class="form-control" name="province" value="<?php echo $province; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="form-group"> 
