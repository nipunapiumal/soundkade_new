            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content"> 
                        ...
                        <div class="row">
                            <div class="col-xs-12">                        
                                <form class="form-horizontal" role="form" action="associate_form_data.php" method="get">            
                                    <div class="widget-box">
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <div>
                                                    <label>Select From Category</label>
                                                    <select class="chosen-select form-control"  name="id" required>
                                                        <?php
                                                        $sql4 = "SELECT * FROM sub_category order by sub_category ASC";
                                                        $result4 = mysqli_query($conn, $sql4);
                                                        echo "<option ></option>";
                                                        while ($row4 = mysqli_fetch_array($result4)) {
                                                            echo "<option value=" . $row4['id'] . ">" . $row4['sub_category'] . "</option>";
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                    ...
                                    <button class="btn btn-primary btn-xs" type="submit"> NEXT </button>
                                </form>   
                            </div>		  		  
                        </div>
                        <br>
