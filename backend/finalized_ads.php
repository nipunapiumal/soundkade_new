...
WHERE
form_prev_data.flag = 1  ORDER BY
form_prev_data.date DESC");
								...
								while ($row = mysqli_fetch_array($sql)) {
    								...
    								<tr> 
    								    ...
    								    <td>
										<button class="btn btn-danger btn-xs remove_btn" value="<?php echo $row['pid']; ?>"> &nbsp;<i class="ace-icon fa fa-trash-o"></i>&nbsp; </button>
    									<!-- Model -->
										<?php include '../common/ad_preview_modal.php'; ?>
    									<!-- // Model -->
    								    </td>
    								    <td>
										<a class="btn btn-info btn-xs" data-toggle="modal" href="#ad_edit_<?php echo $row['pid']; ?>"> &nbsp;<i class="ace-icon fa fa-pencil-square-o"></i>&nbsp;</a>
    									<!-- Model -->
										<?php include '../common/ad_edit_modal.php'; ?>
    									<!-- // Model -->
    								    </td>
										<td>
										<a class="btn btn-success btn-xs" href="edit_post_img.php?pid=<?php echo $row['pid']; ?>"> &nbsp;<i class="ace-icon fa fa-camera"></i>&nbsp;</a>
    								    </td>
    								</tr>
								<?php } ?>
							    </tbody>
		...
		<div class="footer-inner">
		    <div class="footer-content"> <span class=""> &copy; 2021 Soundkade.lk. All Rights Reserved. | Designed by <a href="https://twirti.com/" target="_blank">Twirti Technologies.</a></span> </div>
		</div>
	    </div>
	...
	<script>
		...
		$('.remove_btn').click(function () {   //when press Delete button in the table		    
		    var ad_id = $(this).val();
			...
			$.post("connection/admin_ads_con.php", {remove_ad: 'data', ad_id: ad_id}, function (delMsg) {//delete item
