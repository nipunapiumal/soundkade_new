                    ...
                    <div class="widget-box col-md-12 col-xs-12">
                      <div class="widget-body">
                        <div class="widget-main col-md-12 col-xs-12"> 
                          ...
                          <div class="table-header"> RBO </div>
...
while ($row = mysqli_fetch_array($sql)) {
    ...
    ?>
                                <tr>
                                  ...
                                  <td align="center"><a class="red" href="edit_RBO_location.php?rbo=<?php echo $row['rbo_id']; ?>" target="new"> <i class="ace-icon fa fa-map-marker bigger-130"></i> </a></td>
                                  <td><div class="hidden-sm hidden-xs action-buttons"> <a class="blue" href="#s_<?php echo $x; ?>" data-toggle="modal"> <i class="ace-icon fa fa-search-plus bigger-130"></i> </a> <a class="green" href="#e_<?php echo $x; ?>" data-toggle="modal"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a> <a class="red" href="function/remove_RBO_fun.php?id=<?php echo $row['rbo_id']; ?>" onclick="return confirm('Are you sure you want to delete this account?');"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a> </div>
                                    <div class="hidden-md hidden-lg">
                                      <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                          ...
                                          <li> <a href="function/remove_RBO_fun.php?id=<?php echo $row['rbo_id']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return confirm('Are you sure you want to delete this account?');"> <span class="red"> <i class="ace-icon fa fa-trash-o bigger-120"></i> </span> </a> </li>
                                        </ul>
                                      </div>
                                    </div>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <h3 class="smaller lighter blue no-margin">Edit RBO</h3>
                                          </div>
                                    ...
                                    <div id="e_<?php echo $x; ?>" class="modal fade" tabindex="-1">
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <form class="form-horizontal" role="form" method="post" action="function/edit_RBO_fun.php?id=<?php echo $row['rbo_id']; ?>">
                                            <div class="modal-body">
                                              <table class="table table-bordered">
                                                <tr>
                                                  <th colspan="2">Personal Details</th>
                                                ...
                                                <tr>
                                                  <td>Gender</td>
                                                  <td><label>
                                                      <input type="radio" class="ace" name="gender" value="1" <?php if ($row['gender'] == 1) {
        echo 'checked';
    } ?>/>
                                                      <span class="lbl"> &nbsp;Male</span> </label>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <label>
                                                      <input type="radio" class="ace" name="gender"  value="2" <?php if ($row['gender'] == 2) {
                                                                                                                echo 'checked';
                                                                                                            } ?> />
                                                      <span class="lbl"> &nbsp;Female</span> </label></td>
                                                </tr>
                                                <tr>
                                                  <td>Email Address</td>
    ...
    $sqlds = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM district WHERE did='$ds'")); ?>
                                                    ...
                                                    <input type="hidden" value="<?php echo $sqlds['district']; ?>" id="dist<?php echo $row['rbo_id']; ?>"></td>
                                                </tr>
                                                <tr>
                                                  <td>City</td>
                                                  <td><?php $ct = $row['city'];
