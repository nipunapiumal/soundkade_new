				...
				<!--<div class="widget-box"> 
					...
					<div class="widget-main"> 
						...
						<div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-map-marker"></i> 
						    ...
						    <input placeholder="city" class="form-control" id="city" autocomplete="off"/>
						</div>
						<span id="val_city" style="display:none" class="formError"><font color="#F44336">Please Enter City</font></span>
						<span id="val_city_ext" style="display:none" class="formError"><font color="#F44336">City Name Already Exist.</font></span>
...
FROM
city
Inner Join district ON city.did = district.did ORDER BY cid DESC");
								$x = 0;
								while ($row = mysqli_fetch_array($sql)) {
    								...
    								<tr>
    								    ...
    								    <td><div class="hidden-sm hidden-xs action-buttons"> 
    									    <a class="green" href="#e_<?php echo $row['cid']; ?>" data-toggle="modal"> 
    										<i class="ace-icon fa fa-pencil bigger-130"></i> 
    									    </a> 
    									    <a class="red" href="function/delete_city_fun.php?id=<?php echo $row['cid']; ?>" onclick="return confirm('Are you sure you want to delete this?');">
    									...
    									<div class="hidden-md hidden-lg">
    										...
    										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
    										    ...
    										    <li> <a href="#e_<?php echo $row['cid']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit"> <span class="green"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </span> </a> </li>
    										    <li> <a href="function/delete_city_fun.php?id=<?php echo $row['cid']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return confirm('Are you sure you want to delete this ?');"> <span class="red"> <i class="ace-icon fa fa-trash-o bigger-120"></i> </span> </a> </li>
    										</ul>
    									    </div>
    									</div>

    									<!-- Model -->
    									<div id="e_<?php echo $row['cid']; ?>" class="modal fade" tabindex="-1">
    										...
    										<div class="modal-content">
    										    ...
    										    <form action="function/edit_city_fun.php?id=<?php echo $row['cid']; ?>" method="post">
    											<div class="modal-body">
    											    <table class="table table-bordered">
    												<tr><td width="40%">District</td><td><select class="form-control select2" name="dist" style="width: 100%;" required>
														<?php
														$sql3 = "SELECT * FROM district";
														$result3 = mysqli_query($conn, $sql3);
														echo "<option value=" . $row['did'] . ">" . $row['district'] . "</option>";
														while ($row3 = mysqli_fetch_array($result3)) {
														    echo "<option value=" . $row3['did'] . ">" . $row3['district'] . "</option>";
														}
														?>
    													</select></td></tr>
    												<tr><td width="40%">City</td><td>
    													<input type="text" value="<?php echo $row['city']; ?>" name="city" required="" style="width:100%">
    												    </td></tr>
    											    </table>
    											</div>
