		...
		<div class="main-content-inner">
			...
			<div class="row">
				...
				<div class="widget-box transparent">
					...
					<?php $rbo = htmlspecialchars(trim($_GET['rbo']), ENT_QUOTES, 'UTF-8');
					$sqlrb = "SELECT rbo_register.lat, rbo_register.lng, city.city FROM city Inner Join rbo_register ON rbo_register.city = city.cid WHERE rbo_register.rbo_id = '$rbo'";

					$result_rb = mysqli_query($conn, $sqlrb) or die("Error". mysqli_error($conn));
                    ...
                    <input type="hidden" value="<?php echo $rbo; ?>" id="rbo_id">
...
$("#btn_update").click(function () { 
  ...
  if(rbo_id === '' || lat === '' || lng === '') {
	   swal("Something Went Wrong", "Please Select Location", "warning");
	  	...
	  	$.post('connection/rbo_con.php', {update_rbo_location: 'data', rbo_id: rbo_id,  lat: lat, lng: lng}, 
		function (data) {
		    if (data.msgType === 1) {
				...
				setTimeout(function () {
					...
					function (isConfirm) {
					if (isConfirm) {
						window.location.href = "search_RBO.php";
					}
					});
				}, 300);
