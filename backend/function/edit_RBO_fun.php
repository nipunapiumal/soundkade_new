	...
	if($countu==1){
		...
		//if($_POST['submit']){
		 ...
		 // $city = $_POST['city'];
		  ...
		  $qv = mysqli_query($conn, "UPDATE rbo_register SET name='$name', address='$address', nic='$nic', dob='$dob', gender='$gender', mobile='$mobile', home='$tel', email='$email', b_name='$bname', b_code='$bcode', b_home='$br_name', br_code='$br_code', acc_no='$acc_no', province='$prov', district='$dis', city='$city' WHERE rbo_id='$id'");
