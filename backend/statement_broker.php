...
FROM
erbo_register
Inner Join `user` ON erbo_register.u_name = `user`.`user` WHERE user.user='$user'
";
...
ebro_account.increment_id,
ebro_account.description,
...
FROM
ebro_account
 WHERE ebro_account.ebro_id='$user_id' 
...
FROM
ebro_account
WHERE ebro_account.ebro_id='$user_id' GROUP BY ebro_account.ebro_id
...
";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <span class="input-group-addon"> <i class="ace-icon glyphicon glyphicon-star"></i> </span>
                                                    <input  class="form-control" value="RS <?php echo $balance; ?>/=" />
                                                </div>
