...
while ($row = mysqli_fetch_array($sql)) {
    ...
    ?>
    								<tr> 
    								    ...
    								    <td>
    									<button class="btn btn-danger btn-xs accept_btn" value="<?php echo $row['pid']; ?>"> &nbsp;<i class="ace-icon fa fa-check-square-o"></i>&nbsp; </button>
	...
	<script>
		...
		swal({
		    ...
		    $.post("connection/ebro_ads_con.php", {accept_ad: 'data', ad_id: ad_id, ebro_id: ebro}, function (delMsg) {//delete item
			$.each(delMsg, function (index, valueDel) {
				...
				setTimeout(function () {
				    ...
				    function (isConfirm) {
					if (isConfirm) {
					    window.location.href = "ebro_pending_ads.php";
					}
				    });
				}, 200);
