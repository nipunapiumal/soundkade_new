                            ...
                            <div class="col-xs-12"> 
                                ...
                                <div class="widget-box transparent">
                                    <div class="widget-header">
                                        <h4 class="widget-title lighter smaller"> <i class="ace-icon fa fa-user orange"></i> Broker Registration </h4>
                                                        ...
                                                        <div class="widget-body">
                                                            <div class="widget-main"> 
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-earphone"></i> </span>
                                                                        <input class="form-control input-mask-phone" type="text"  placeholder="(999) 999-9999" id="reg_mob"/>
                                                                    </div>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	    
            ...
            function load_province() {
                ...
                $.post('connection/bro_con.php', {'get_province': 'data'}, function (data) {
                    $("#province").html(data);
                });
            ...
            function save_info_bro() {
                ...
                $.post('connection/bro_con.php', {save_bro: 'data', name: name, address: address, nic: nic, dob: dob, gender: gender, mobile: mobile, home: home, email: email, bank_name: bank_name, bank_code: bank_code, branch_home: branch_home, branch_code: branch_code, acc_no: acc_no, province: province, district: district, city: city, reg_mob: reg_mob, hidden_id: hidden_id}, //pass data to database
                function (data) {
                    if (data.msgType === 1) {
            ...
            function load_district(id) {
                ...
                $.post('connection/bro_con.php', {'get_district': 'data', id: id}, function (data) {
                    $("#district").html(data);
                });
            ...
            function load_city(id) {
                ...
                $.post('connection/bro_con.php', {'get_city': 'data', id: id}, function (data) {
                    $("#city").html(data);
                });
...
/////////////////////////////////////////////////end validation//////////////////////////////////////////////
            ...
            $(function () {
                ...
                $("#save").click(function () {
                    ...
                    if ((nic && valid_nic && validate_per && validate_bank && validate_loc && validate_fin && mail) === false) {
                        sweetAlert("Oops...", "Please Check form field !", "error");
                    }

                    if (nic && valid_nic && validate_per && validate_bank && validate_loc && validate_fin) {
                        save_info_bro();
                        $('.nav-tabs > .active').prev('li').find('a').trigger('click');
                        $('.nav-tabs > .active').prev('li').find('a').trigger('click');
                        $('.nav-tabs > .active').prev('li').find('a').trigger('click');
