...
$sql5 = "SELECT * FROM  city WHERE cid='$id'";
$result5 = mysqli_query($conn, $sql5);
while ($row5 = mysqli_fetch_array($result5)) {

    $district_id = $row5['did'];
    $city = $row5['city'];

    $sql7 = "SELECT * FROM  district WHERE did='$district_id'";
                                    ...
                                    <div class="widget-body"> 
                                        <div class="widget-main"> 
                                            ...
                                            <form class="form-horizontal" role="form" 
                                                  action="function/edit_city_fun.php?id=<?php echo $id; ?>&&city2=<?php echo $city; ?>" method="post">
                                                <div class="form-group"> 
                                                    <label>District:</label>
                                                    <select class="form-control select2" name="district_id" style="width: 100%;" required>
                                                        <?php
                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <div class="input-group"> <span class="input-group-addon"> 
                                                        ...
                                                        <input class="form-control" name="city" value="<?php echo $city; ?>" required/>
                                                    </div>
                                                </div>
                                                <div class="form-group"> 
                                                    <button id="" type="submit" class="btn btn-primary btn-sm"> 
                                                        Update </button>
                                                </div>
                                            </form>
                                            <!-- End Content -->
