                                        ...
                                        <div class="widget-box col-md-12 col-xs-12">
                                            <div class="widget-body">
                                                <div class="widget-main col-md-12 col-xs-12"> 
                                                    <div class="table-header"> Admin</div>
...
rbo_register.rbo_id,
rbo_account.`date`,
rbo_account.`increment_id`,
rbo_account.debit,
rbo_account.amount,

rbo_account.description,
rbo_account.credit,
rbo_register.name
FROM
rbo_register
Inner Join rbo_account ON rbo_account.rbo_id = rbo_register.rbo_id WHERE description='Funds Rezived From Admin'
");
                                                                ...
                                                                while ($row = mysqli_fetch_array($sql)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>Transfer to <?php echo $row['name']; ?></td>
                                ...
                                <div class="widget-box first">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <?php
                                            $sql2 = "SELECT
SUM(rbo_account.debit)AS de,
rbo_account.description
FROM
rbo_account
WHERE rbo_account.description='Funds Rezived From Admin' GROUP BY rbo_account.description
...
";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <span class="input-group-addon"> <i class="ace-icon glyphicon glyphicon-star"></i> </span>
                                                    <input  class="form-control" value="RS <?php echo $debit; ?>/=" />
                                                </div>
