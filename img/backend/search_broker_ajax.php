...
<html lang="en">
					...
					<div class="widget-box tbl2" hidden="">
						...
						<div class="widget-main">
							...
							<div class="input-group"> <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span>
							    <input class="form-control date-picker dob" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" />
							</div>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label>
							    <input name="form-field-radio" type="radio" class="ace" checked id="male" value="1"/>
							    <span class="lbl"> &nbsp;Male</span> </label>
							&nbsp;&nbsp;&nbsp;
							<label>
							    <input name="form-field-radio" type="radio" class="ace" id="female" value="2"/>
							    <span class="lbl"> &nbsp;Female</span> </label>
						    </div>
						    <div class="form-group">
							<label>Contact No (Mobile):</label>
							<div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-earphone"></i> </span>
							    <input class="form-control input-mask-phone mobile" type="text" id="form-field-mask-2" placeholder="(999) 999-9999" />
							</div>
							...
							<div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-phone-alt"></i> </span>
							    <input class="form-control input-mask-phone home" type="text" id="form-field-mask-2" placeholder="(999) 999-9999"/>
							</div>
							...
							<div class="input-group"><span class="input-group-addon"><i class="fa fa-building"></i></span>
							    <input placeholder="Branch Name" class="form-control" id="branch_name"/>
							</div>
						    ...
						    <!-- Content -->
						    <div class="form-group">
							<label>Registered Mobile_number:</label>
							<div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-earphone"></i> </span>
							    <input class="form-control input-mask-phone reg_mob" type="text" id="form-field-mask-2" placeholder="(999) 999-9999" />
							</div>
							<span id="val_regmob" style="display:none" class="formError"><font color="#F44336">Please Enter Registered Mobile Number</font></span>
						    </div>
						    <!--<div class="form-group">
					...
					<div class="widget-box col-md-12 col-xs-12">
						...
						<div class="widget-main col-md-12 col-xs-12"> 
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							    ...
							    <tbody>
								<?php
								$sql = mysqli_query($conn, "SELECT * FROM  bro_register ORDER by bro_id ASC");
								$x = 0;
								while ($row = mysqli_fetch_array($sql)) {
    								...
    								<tr> 
    								    ...
    								    <td><div class="hidden-sm hidden-xs action-buttons"> 
    									    ...
    									    <button value="<?php echo $row['bro_id']; ?>" class="btn1 "><a class="green" data-toggle="modal"> 
    										    <i class="ace-icon fa fa-pencil bigger-130"></i> 
    										</a></button> 
    									    <button value="<?php echo $row['bro_id']; ?>" class="delete"><a class="red" href="#">
    									...
    									<div class="hidden-md hidden-lg"> 
    										...
    										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
    										    ...
    										    <li> 
    											<button value="<?php echo $row['bro_id']; ?>" class="btn1"><a data-toggle="modal" class="tooltip-success" data-rel="tooltip" title="Edit"> 
    										    ...
    										    <li> 
    											<button value="<?php echo $row['bro_id']; ?>" class="delete"><a href="#" class="tooltip-error" data-rel="tooltip" title="Delete"> 
	...
	<script>
	    ...
	    /* function load_district_direct(id) {
		$.post('connection/search_broker_fun.php', {'get_district_direct': 'data', prov_id: id}, function (data) {
		    $("#district").html(data);
		});

	    } */

	   /*  function load_city_direct(id) {

		$.post('connection/search_broker_fun.php', {'get_city_direct': 'data', dist_id: id}, function (data) {
		    $("#city").html(data);
		});
...
/* 	    function load_province() {
		...
		$.post('connection/search_broker_fun.php', {update_broker: 'data', id: id, name: name, address: address, nic: nic, dob: dob, mobile: mobile, home: home, email: email, bank_name: bank_name, bank_code: bank_code, branch_name: branch_name, branch_code: branch_code, acc_no: acc_no, reg_mob: reg_mob, province: province, district: district, city: city, gen: gen}, //pass data to model
		function (data) {
		    if (data.msgType === 1) {
...
//////////////////////////////////////validation////////////////////////////
		...
		$(".btn1").click(function () { 
			...
			$.each(up, function (index, data) {
				...
				//$('<option>').val(data.pid).html(data.pro).appendTo("#province").prop("selected", true);
				//$('<option>').val(data.did).html(data.dis).appendTo("#district").prop("selected", true);
				//$('<option>').val(data.cid).html(data.cit).appendTo("#city").prop("selected", true);
				...
				load_province(data.pid, data.pro);
				load_district_direct(data.pid, data.did, data.dis);
				load_city_direct(data.did, data.cid, data.cit);				
				
				function load_province(pid, pname) {
					$.post('connection/search_broker_fun.php', {'get_province': 'data', prov_id: pid, pname:pname}, function (data) {
						$("#province").html(data);
					});

				}

				function load_district_direct(pid, did, dname) {
					$.post('connection/search_broker_fun.php', {'get_district_direct': 'data', prov_id: pid, dist_id: did, dname: dname,}, function (data) {
						$("#district").html(data);
					});
				}
								
				function load_city_direct(did, cid, cname) {
					$.post('connection/search_broker_fun.php', {'get_city_direct': 'data', dist_id: did, c_id:cid, cname:cname}, function (data) {
