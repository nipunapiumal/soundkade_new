...
if (!isset($_SESSION)) {
    ...
    $sql_id = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM consult_register WHERE u_name='$user'"));
    $con_id = $sql_id['con_id'];
				...
				<div class="row">
					...
					<div class="widget-box col-md-12 col-xs-12">
						...
						<div class="widget-main col-md-12 col-xs-12"> 
						    ...
						    <div class="table-header">Transactions Pool</div>
...
WHERE
cus_transaction.trans_flag =  '1' AND
cus_transaction.consult_id ='$con_id'");
								$x = 0;
...
form_prev_data.id = '$post_id'"));
    								...
    								<tr> 
    								    ...
    								    <td><?php echo $row1['trans_name']; ?></td>

    								    <td><!--<a class="btn btn-success btn-xs model" data-toggle="modal" href="#con_<?php /*echo $row['pid'];*/ ?>"> &nbsp;<i class="ace-icon fa fa-check-square-o"></i>&nbsp; </a>
								    <input type="text" name="trans_id" value="<?php /*echo $id;*/ ?>" id="trans_increment_id_<?php /*echo $id; */?>">-->
									<button data-toggle="modal" href="#con_<?php echo $row['pid']; ?>" value="<?php echo $id; ?>" id="increment_id_<?php echo $id; ?>" class="btn btn-success btn-mini  increment_id"> Upload</button>
    									<!-- Model -->
									    <?php include '../common/ad_preview_modal.php'; ?>
    									<!-- // Model -->
    									<!--  Model -->

    									<div id="con_<?php echo $row['pid']; ?>" class="modal fade model_1" tabindex="-1"> 
    										...
    										<div class="modal-content">
    											...
    											<form action="connection/consult_trans_con.php" method="post" enctype="multipart/form-data">
    											    <table class="table table-bordered">

    												<tr><td>Upload File</td><td align="right">
											    ...
											    <input type="hidden" name="trans_id" value="<?php echo $id; ?>" id="form_id">
	...
	<script>
	    ...
	    function load_model_data(increment_id) {
		//var hidden_input = $('#hidden_input').val();
		var tableData;
		var postData = {load_data: 'table', increment_id: increment_id};//data pass to model
		$.post("connection/rbo_consult_con.php", postData, function (e) {
			...
			$.each(e, function (index, data) {
			    tableData += '<tr>';
			    tableData += '<td align="left">' + data.upload_name + '</td>';
			...
			$('.delete_com').click(function () {   //when press Delete button in the table
				...
				$.post("connection/rbo_consult_con.php", {delete_data: 'delete', id_for_delete: id_for_delete}, function (delMsg) {//delete item
				    ...
				    load_model_data();
				    //$('.model_1').modal('hide');
				    window.location.href = "consult_trans.php";
				}, "json");
	     ...
	     var add = $(this).val();
	     var increment_id = $('#increment_id_'+add).val();
	     
	     $('#form_id').val(increment_id);
		//alert(increment_id);
		load_model_data(increment_id);
