...
$sql5 = "SELECT * FROM  district WHERE did='$id'";
$result5 = mysqli_query($conn, $sql5);
while ($row5 = mysqli_fetch_array($result5)) {

    $province_id = $row5['pid'];
    $district = $row5['district'];

    $sql7 = "SELECT * FROM  province WHERE pid='$province_id'";
    $result7 = mysqli_query($conn, $sql7);
    while ($row7 = mysqli_fetch_array($result7)) {

        $province = $row7['province'];
    }
}
?>
                                    ...
                                    <div class="widget-body"> 
                                        <div class="widget-main"> 
                                            ...
                                            <form class="form-horizontal" role="form" 
                                                  action="function/edit_district_fun.php?id=<?php echo $id; ?>&&district2=<?php echo $district; ?>" method="post">

                                                <div class="form-group"> 

                                                    <label>Province:</label>
                                                    <select class="form-control select2" name="province_id" style="width: 100%;" required>
                                                        <?php
                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <div class="input-group"> <span class="input-group-addon"> 
                                                        ...
                                                        <input class="form-control" name="district" value="<?php echo $district; ?>" required/>
                                                    </div>
                                                </div>
                                                <div class="form-group"> 
