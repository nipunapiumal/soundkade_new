...
<html lang="en">
		...
		<div class="main-content-inner">
			...
			<div class="row">
				...
				<div class="widget-box transparent">
					...
					<h4 class="widget-title lighter smaller"> <i class="ace-icon fa fa-fax orange"></i> Consultant Registration </h4>
						...
						<div id="t1" class="tab-pane active"> 
							...
							<div class="widget-body">
								...
								<div class="form-group">
									...
									<input class="form-control date-picker" id="dob" type="text" data-date-format="yyyy-mm-dd" />
								...
								<div class="form-group">
								    ...
								    &nbsp;&nbsp;&nbsp;
								    <label>
									<input name="form-field-radio" type="radio" class="ace" id="genFemale" value="2"/>
								...
								<div class="form-group">
								    <a class="btn btn-info btn-sm " id="nxt1">Next</a>
								</div>
								<!-- End Content --> 
							    </div>
							</div>
	...
	<script type="text/javascript">
		...
		$.post('connection/consult_con.php', {'get_province': 'data'}, function (data) {
		    $("#province").html(data);
		});
		...
		$.post('connection/consult_con.php', {save_rbo: 'data', name: name, address: address, nic: nic, dob: dob, gender: gender, mobile: mobile, home: home, email: email, bank_name: bank_name, bank_code: bank_code, branch_home: branch_home, branch_code: branch_code, acc_no: acc_no, province: province, district: district, city: city, u_name: u_name, pass: pass}, //pass data to database
		function (data) {
		    if (data.msgType === 1) {
		...
		$.post('connection/consult_con.php', {'get_district': 'data', id: id}, function (data) {
		    $("#district").html(data);
		});
		...
		$.post('connection/consult_con.php', {'get_city': 'data', id: id}, function (data) {
		    $("#city").html(data);
		});
...
///////////////////////////////////////////////start validation///////////////////////////////////////////////////////	    
		...
		$.post('connection/consult_con.php', {username_validation: 'data', username: username},
		function (data) {
		...
		var nic = $('#nic').val();
		$.post('connection/consult_con.php', {nic_validation: 'data', nic: nic},
		function (data) {
		    $.each(data, function (index, data) {
			if (data.nic_count === "1") {
		...
		if ($('#province').val() === 'Select Yout Province....') {
