                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group input-group-lg" style="width:100%">
                                                <select name="city" class="form-control selectpicker">
                                                    <option></option>
						    <?php
						    $sqlp = mysqli_query($conn, "SELECT * FROM city ORDER BY city ASC");
						    while ($rowp = mysqli_fetch_array($sqlp)) {
							?>
    						    <option value="<?php echo $rowp['cid']; ?>"><?php echo $rowp['city']; ?></option>
						    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="input-group input-group-lg" style="width:100%">
                                                <select name="subcat" class="form-control selectpicker">
                                                    <option></option>
						    <?php
						    $sql = mysqli_query($conn, "SELECT * FROM sub_category ORDER BY sub_category ASC");
            ...
            <div role="main">
				...
				<?php }
                 ...
                 ?>
					...
					<div class="price col-md-4"><strong>Rs.</strong><span class=""><?php if ($price[2]=='.') {
