                                    ...
                                    <form method="get" action="search.php">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group input-group-lg" style="width:100%">
                                                ...
                                                <select name="city" class="form-control selectpicker" id="drop_city">
						    <?php
						    $sqlc = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM city  WHERE cid='$city'"));
						    $cid = $sqlc['cid'];
						    $city_drop = $sqlc['city'];
						    ?>
                                                    <option value="<?php echo $cid; ?>"><?php echo $city_drop; ?></option>
						    <?php
						    ...
						    <?php } ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group input-group-lg" style="width:100%">
                                                ...
                                                <select name="subcat" class="form-control selectpicker" id="drop_subcat">
						    <?php
						    $sqls = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM sub_category   WHERE id='$subcat'"));
						    $ids = $sqls['id'];
						    $sub_category = $sqls['sub_category'];
						    ?>
                ...
                <div id="content" class="content full">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="sidebar right-sidebar col-md-3 hidden-sm" id="sidebar-col">
					...
					while ($rowse = mysqli_fetch_array($result)) {
    					...
    					<li class="type-rent col-md-12">
							...
							<?php if ($rowse['cat'] != 4 && $rowse['cat'] != 5) { ?>
							    <div class="price"><strong>Rs.</strong><span class=""><?php 
                                //echo $price[0];
                                if ($price[2]=='.') {
