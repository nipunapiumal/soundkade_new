  ...
  <div class="site-showcase"> 
    ...
    <div class="parallax page-header" style="background-image:url(img/forgot-password-banner.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1><font color="#000">Reset Password</font></h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12" id="content-col">
			...
			if (array_key_exists('email', $_GET)) {
				$sql = "SELECT * FROM customer_reg WHERE email='".trim($_GET['email'])."' LIMIT 1";
				$result = mysqli_query($conn, $sql);
				
				if(mysqli_num_rows($result)> 0){//this means this user exists. so we can resend him the email
                    ...
                    $activationlink = "https://soundkade.lk/activate_user.php?id={$row['id']}&activetoken={$row['token']}";
                    $emailsubject = "Your account activation Soundkade.lk";
                    $contents = "<p>Dear {$receivername},</p>
            			<p>We are resending your account activation email as you requested.Please <a href='$activationlink'>click on this  activation link</a> to activate your account.
            			</p>
            ...
            $mail->addAttachment('email/logo1.png');
                    ...
                    if (!$mail->send()) {
                        ...
                        echo "Email successfully sent. Please check your email inbox";
