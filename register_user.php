...
if ($_POST) {
	...
	if($count != 0){
	  ...
	  if (mysqli_query($conn, $sql)) {
        ...
        //$activationlink = "http://localhost/soundkade/activate_user.php?id={$thisusersid}&activetoken={$token}";
        $activationlink = "https://soundkade.lk/activate_user.php?id={$thisusersid}&activetoken={$token}";
        $emailsubject = "You have been registered at Soundkade.";
        $contents = "<p>Dear {$name},</p>
			<p>You have been registered at Soundkade.LK. Before you can login, you must activate your account.Please <a href='$activationlink'>click on this  activation link</a> to activate your account.
			</p>
        ...
        //$mail->addAddress("nipu.piumal@gmail.com", "Nipuna Piumal");
